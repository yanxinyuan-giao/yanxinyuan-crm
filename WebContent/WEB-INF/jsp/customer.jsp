			...
			<ul class="nav navbar-top-links navbar-right">
				...
				<li class="dropdown"><a class="dropdown-toggle"
					...
					<ul class="dropdown-menu dropdown-messages">
						<li><a href="#">
								<div>
									<strong>闫董事长</strong> <span class="pull-right text-muted">
										<em>昨天</em>
									</span>
								</div>
								<div>明天早上开会，汇报一下你们这个月的项目成果...</div>
						</a></li>
						<li class="divider"></li>
				...
				<li class="dropdown"><a class="dropdown-toggle"
					...
					<ul class="dropdown-menu dropdown-tasks">
						<li><a href="#">
								<div>
									<p>
										<strong>任务 1</strong> <span class="pull-right text-muted">完成100%</span>
									</p>
						...
						<li><a href="#">
								<div>
									<p>
										<strong>任务 2</strong> <span class="pull-right text-muted">完成30%</span>
									</p>
									<div class="progress progress-striped active">
										<div class="progress-bar progress-bar-info" role="progressbar"
											aria-valuenow="20" aria-valuemin="0" aria-valuemax="100"
											style="width: 30%">
											<span class="sr-only">完成30%</span>
										</div>
									</div>
								</div>
						</a></li>
						...
						<li><a href="#">
								<div>
									<p>
										<strong>任务 3</strong> <span class="pull-right text-muted">完成0%</span>
									</p>
									<div class="progress progress-striped active">
										<div class="progress-bar progress-bar-success"
											role="progressbar" aria-valuenow="40" aria-valuemin="0"
						...
						<li><a href="#">
								<div>
									<i class="fa fa-comment fa-fw"></i> 新回复 <span
										class="pull-right text-muted small">1分钟之前</span>
								</div>
						</a></li>
						<li class="divider"></li>
						<li><a href="#">
								<div>
									<i class="fa fa-envelope fa-fw"></i> 新消息 <span
										class="pull-right text-muted small">5分钟之前</span>
								</div>
						</a></li>
						<li class="divider"></li>
						<li><a href="#">
						...
						<li><a href="#">
								<div>
									<i class="fa fa-upload fa-fw"></i> 服务器重启 <span
										class="pull-right text-muted small">1小时之前</span>
								</div>
						</a></li>
						<li class="divider"></li>
				...
				<div class="sidebar-nav navbar-collapse">
					<ul class="nav" id="side-menu">
						...
						<li><a
							...
							class="active"> <i class="fa fa-edit fa-fw"></i> 客户信息
						</a></li>
						...
						<li><a href="#"> <i class="fa fa-unlock-alt fa-fw"></i>
								权限管理
						</a></li>
						<li><a href="#"> <i class="fa fa fa-file-text-o fa-fw"></i>
								公告信息
						</a></li>
